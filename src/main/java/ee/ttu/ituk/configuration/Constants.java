...
public class Constants {
    ...
    public static final String BASE_URL = "https://api.planetos.com/v1/datasets/" +
            "noaa_gfs_pgrb2_global_forecast_recompute_0.25degree/point?origin=dataset-details";
